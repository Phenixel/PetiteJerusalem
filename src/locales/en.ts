...
const en: LocaleMessages = {
  ...
  dailyReading: {
    ...
    description:
      "Compose your day: texts to read, things to do, your own goals. Tick them off every day and grow your streak.",
    ...
    emptyDescription:
      "Add texts to read, things to do or your own goals: everything gets ticked off here, every day.",
    ...
    options: {
      ...
      dafYomiDescription:
        "The page of Talmud the whole world studies on the same day: one daf a day, the whole Shas in seven and a half years.",
      parashaReading: "Parasha of the week",
      tehilimDayReading: "Daily Tehilim · day {day} of the month",
      dafYomiReading: "Daf Yomi",
      dafYomiLabel: "{tractate} · Daf {daf}",
      dafYomiMissing: "This daf is not in the library: you can still tick it off once studied.",
      psalmsOne: "Tehilim {n}",
    ...
    actions: {
      title: "Daily actions",
      description:
        "Things to do each day, ticked off next to your readings: they count in your progress and in your streak.",
      doneToday: "Done today",
      open: "Open the text",
      until: "until {time}",
      chaharitTitle: "Shacharit",
      chaharitDescription: "The morning prayer.",
      minhaTitle: "Mincha",
      minhaDescription: "The afternoon prayer.",
      arvitTitle: "Arvit",
      arvitDescription: "The evening prayer.",
      tefilinTitle: "Tefillin",
      tefilinDescription: "Put on tefillin.",
      tsedakaTitle: "Tzedakah",
      tsedakaDescription: "Give, even a coin.",
      chemaTitle: "Shema before sleep",
      chemaDescription: "The bedtime Shema.",
      etudeTitle: "Torah study",
      etudeDescription: "A passage, a mishna, a page: study every day.",
    },
    goals: {
      title: "My goals",
      description:
        "In your own words, at your own pace: every day, so many times a week, a month, a year, or forty days in a row like Perek Shirah.",
      placeholder: "A goal, in your own words",
      add: "Add",
      everyDay: "Every day",
      restart: "Start again",
      finishedTitle: "Completed programs",
      customHint: "days in a row, starting today",
      programDay: "Day {day} of {days}",
      programDone: "{days} days completed",
      periods: {
        day: "Every day",
        week: "Per week",
        month: "Per month",
      ...
      timesPer: {
        ...
        month: "time a month | time a month | times a month",
        year: "time a year | time a year | times a year",
      },
      periodTimes: {
        week: "{n} time a week | {n} time a week | {n} times a week",
        month: "{n} time a month | {n} time a month | {n} times a month",
        year: "{n} time a year | {n} time a year | {n} times a year",
      },
      periodTitles: {
        week: "This week",
        month: "This month",
      ...
      presets: {
        ...
        perekChira: "Perek Shirah",
        birkatHalevana: "Birkat Halevana",
        chiour: "Listen to a shiur",
        parents: "Call my parents",
        tehilimMois: "Finish Tehilim",
        mezouzot: "Have my mezuzot checked",
      },
      remove: "Remove this goal",
      limit: "You have reached {max} goals: remove one to add another.",
    },
    streak: {
      title: "Day streak",
      days: "day in a row | day in a row | days in a row",
      best: "Best: {n} days",
      bestShort: "best",
      bestTitle: "Your longest streak",
      doneToday: "Everything is done today: the streak goes on tomorrow.",
      atRisk: "Finish your goals before midnight to keep your streak.",
      atRiskFreeze:
        "A day was missed: a streak freeze covers it if you finish today. | A day was missed: a streak freeze covers it if you finish today. | {n} days were missed: your freezes cover them if you finish today.",
      paused: "Rest day: your streak holds without doing anything. Ticking off is still possible.",
      restart: "Finish all your goals today to start a new streak.",
      start: "Finish all of today's goals to start a streak.",
      widgetTitle: "Streak",
      widgetDays: "day in a row | day in a row | days in a row",
      widgetZero: "Finish your day to start a streak",
      widgetBest: "Best: {n}",
      share: "Share my streak",
      shareDownloaded: "Your streak image has been downloaded.",
    },
    freezes: {
      count:
        "No streak freeze in reserve | 1 streak freeze in reserve | {n} streak freezes in reserve",
      hint: "A full week of streak earns one ({max} at most): a missed day uses it instead of breaking the streak.",
    },
    rules: {
      title: "My successful day",
      description:
        "What must be ticked off for the day to count in your streak. Everything is demanding; one thing is sustainable.",
      all: "Everything",
      half: "At least half",
      one: "At least one thing",
      short: {
        all: "day counts when everything is done",
        half: "day counts at half",
        one: "day counts from one thing done",
      },
      restDays: "Shabbat and Yom Tov paused",
      restDaysHint:
        "Those days count neither for nor against: the streak carries over them without you opening the app.",
    },
    editor: {
      title: "Fix a day",
      hint: "Tick what you had done that day. Your streak is then recomputed.",
      open: "Fix the {day}",
      weekHint: "Forgot a day? Tap it to fix it, up to seven days back.",
      yesterday: "Yesterday is not ticked. Did you do it?",
      fixYesterday: "Fix yesterday",
      checkAll: "Tick all",
      uncheckAll: "Untick all",
      save: "Save",
      saved: "The day is fixed.",
      savedStreak: "The day is fixed: your streak is at {n} days.",
    },
    week: {
      title: "This week",
    ...
    totals: {
      days: "successful day | successful day | successful days",
      psalms: "psalm read | psalm read | psalms read",
      dafim: "daf studied | daf studied | dafim studied",
      prayers: "prayer | prayer | prayers",
    },
    milestones: {
      title: "Milestones",
      days: "{n} days",
    ...
    celebration: {
      kicker: "Successful day",
      title: "Well done, everything is done!",
      milestone: "{n} days in a row!",
      siyoum: "Siyum of {tractate}!",
      program: "{label}: program completed!",
      newBest: "Your longest streak so far.",
      freezeEarned: "A full week: you earn a streak freeze.",
      close: "Continue",
    },
    challenges: {
      kicker: "Seasonal challenge",
      omer: "The 49 days of the Omer",
      "yamim-noraim": "From Elul to Kippur",
      hanouka: "The eight nights of Chanukah",
      progress: "Day {day} of {total} · {done} successful days",
    },
    progressChips: {
    ...
    packs: {
      ...
      lireTitle: "Read",
      lireDescription: "The daily Tehilim and the weekly parasha, every day.",
      faireTitle: "Do",
      faireDescription: "The three prayers and tefillin, ticked off through the day.",
      progresserTitle: "Grow",
      progresserDescription: "Daf Yomi, a study slot, tzedakah, and a goal of your own.",
      progresserGoal: "Ten minutes of mussar",
      compose: "Compose it myself",
    },
  ...
  feedback: {
    title: "Write to us",
    subtitle: "An idea, a bug, a mistake in a text? Tell us, every message is read.",
    homePrompt: "An idea, a problem?",
    homeLink: "Write to us",
    kindLabel: "What is it about?",
    kinds: {
      idea: "A new idea",
      bug: "A bug",
      error: "A mistake (in a text, a time, a translation)",
      other: "Something else",
    },
    otherLabel: "Tell us more",
    otherPlaceholder: "In a few words…",
    detailsLabel: "Give us details",
    detailsPlaceholder: "What you did, what you expected, what happened…",
    contactToggle: "You may contact me",
    contactHint: "Only to answer you or ask you a question.",
    contactLabel: "Email or phone",
    contactPlaceholder: "you{'@'}example.com or +33 6 12 34 56 78",
    contextNote: "Sent with: {context}.",
    context: {
      web: "Website",
      app: "App",
      ios: "iOS",
