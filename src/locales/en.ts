...
const en: LocaleMessages = {
  ...
  seo: {
    searchTitle: "Search {'|'} Petite Jérusalem",
  ...
  /* Unified search (/recherche): texts, reading chains, chiourim, cities,
     holidays and pages in one place, typed or spoken. */
  search: {
    title: "Search",
    subtitle: "A text, a reading chain, a chiour, a city, a holiday: everything is searched here.",
    placeholder: "Search a text, a chain, a chiour…",
    launcherPlaceholder: "Search Petite Jérusalem…",
    hint: "Type the name of a tractate, a psalm, a parasha, a city or a holiday, or dictate it. In Hebrew, the search also reads the text of the books on this device.",
    clear: "Clear",
    noResults: "Nothing matches “{term}”.",
    more: "and {count} more",
    sections: {
      pages: "Pages",
      texts: "Texts",
      passages: "In the texts",
      sessions: "Reading chains",
      chiourim: "Chiourim",
      cities: "Times",
      festivals: "Calendar",
    },
    finished: "Ended",
    remoteLoading: "Loading reading chains and chiourim…",
    remoteFailed: "Reading chains and chiourim could not be loaded. Check the connection and try again.",
    offlineRemote: "Offline, reading chains and chiourim cannot be searched.",
    passagesScope:
      "In the text of {count} book on this device. | In the text of the {count} books on this device.",
    passagesShort: "Type at least {count} letters to search inside the text.",
    passagesSearching: "Reading the texts…",
    passagesNone: "No passage contains “{term}” in the books on this device.",
    voice: {
      start: "Dictate",
      stop: "Stop dictating",
      listening: "Listening…",
      unsupported: "Dictation is not available on this device.",
      denied: "Microphone access was refused. You can allow it in the device settings.",
      noSpeech: "I did not hear anything.",
      network: "Dictation needs a connection on this device.",
