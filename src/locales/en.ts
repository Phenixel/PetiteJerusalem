...
const en: LocaleMessages = {
  ...
  dailyReading: {
    ...
    goals: {
      title: "My goals",
      description:
        "What you want to do every day, in your own words: ten minutes of mussar, a call to your parents, one more chapter.",
      placeholder: "A goal for every day",
      add: "Add",
      everyDay: "Every day",
      perWeek: "{n} time a week | {n} time a week | {n} times a week",
      weeklyTitle: "This week",
      weeklyProgress: "{done} of {total} this week",
    ...
    catchUp: {
      question: "Yesterday is not ticked off. Did you do everything?",
      confirm: "Yes, yesterday was done",
      done: "Yesterday counts: your streak goes on.",
    },
    week: {
      title: "This week",
