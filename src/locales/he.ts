...
const he: LocaleMessages = {
  ...
  study: {
    ...
    corpus: {
      ...
      sidourDesc: "שחרית, מנחה וערבית של חול, עם זמני התפילה לפי המיקום ותוספות הלוח יום ביום.",
      slihotDesc: "סליחות כמנהג עדות המזרח, לחודש אלול ולעשרת ימי תשובה.",
      brahotDesc: "ברכת המזון, ברכה אחרונה, שבע ברכות, ברכת הלבנה: הברכות בהישג יד.",
