...
const he: LocaleMessages = {
  ...
  zmanim: {
    ...
    navTitle: "זמנים",
    description:
      "זמני היום ההלכתיים, מחושבים למיקום שלכם. הכול מחושב במכשיר שלכם, כך שהזמנים זמינים גם ללא חיבור לאינטרנט.",
    next: "הזמן הבא",
    ...
    place: {
      ...
      privacy: "המיקום שלכם נשאר במכשיר זה ואינו נשלח לשום מקום.",
    },
    periods: {
      dawn: "עלות השחר והנץ",
