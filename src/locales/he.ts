...
const he: LocaleMessages = {
  ...
  onboarding: {
    ...
    library: {
      title: "הספרייה, עם חיבור ובלעדיו",
      intro: "כל הטקסטים במקום אחד: תהילים, משנה, תלמוד, תנ״ך, סידור, סליחות וברכות.",
      corpusTitle: "שבעה אוספים, קורא אחד",
      corpusText: "עברית ותעתיק, גודל הטקסט נקבע פעם אחת, אותה חוויית קריאה מתחילתה ועד סופה.",
      searchTitle: "למצוא בלי לחפש",
      searchText: "חיפוש אחד לכל הספרייה: מסכת, פרשה או ברכה.",
      resumeTitle: "להמשיך מהמקום שעצרתם",
      resumeText: "הסימניות וסימני הקריאה מחזירים אתכם לפסוק הנכון, בכל אחד מהמכשירים שלכם.",
