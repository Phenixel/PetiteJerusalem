...
const he: LocaleMessages = {
  ...
  notifications: {
    ...
    enable: "הפעלת תזכורת יומית",
    disable: "כיבוי התזכורת",
    enabled: "התזכורת פעילה: תקבלו התראה כל יום ב-{hour}:00 אם הקריאה לא הושלמה.",
    hourLabel: "שעת התזכורת",
    ...
    test: "שליחת התראת ניסיון",
    testSent: "התראת ניסיון נשלחה ל-{count} מכשירים. אם היא לא מופיעה, בדקו את הגדרות הטלפון.",
    testNoToken: "אין מכשיר רשום לחשבון זה. כבו והפעילו מחדש את התזכורת ונסו שוב.",
    testFailed: "השליחה נכשלה ({error}). כבו והפעילו מחדש את התזכורת ונסו שוב.",
  },
  study: {
    title: "ספרייה",
