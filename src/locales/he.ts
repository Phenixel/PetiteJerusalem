...
const he: LocaleMessages = {
  ...
  detailSession: {
    ...
    randomDraw: {
      ...
      subtitle: "תנו לגורל לבחור עבורכם: הפרק שהוגרל נשמר מיד על שמכם, גם בלי חשבון.",
      button: "הגרלת פרק תהילים",
      drawing: "מגרילים...",
      noneAvailable: "כל פרקי התהילים בסשן הזה כבר שמורים.",
      yourDraw: "ההגרלה שלכם",
      reservedForYou: "שמור עבורכם",
      readThanks: "נקרא, תודה!",
      markRead: "סמן כנקרא",
      cancel: "ביטול",
      drawAnother: "הגרלת פרק נוסף",
      anonymous: "אנונימי",
    },
    instructions: {
      title: "הוראות",
