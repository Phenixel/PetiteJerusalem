const fr = {
  ...
  profile: {
    ...
    nameUpdateError: "La mise à jour du nom d'affichage a échoué. Réessayez.",
    emailReadOnly: "Adresse de connexion du compte : elle ne se modifie pas depuis cette page.",
  ...
  textReading: {
    ...
    drawLost:
      "Ce Téhilim a été repris : la réservation avait expiré. Tirez-en un autre pour continuer.",
  ...
  feedback: {
    title: "Écrivez-nous",
    subtitle: "Une idée, un bug, une erreur dans un texte ? Dites-le nous, chaque message est lu.",
    homePrompt: "Une idée, un problème ?",
    homeLink: "Écrivez-nous",
    kindLabel: "De quoi s'agit-il ?",
    kinds: {
      idea: "Une nouvelle idée",
      bug: "Un bug",
      error: "Une erreur (dans un texte, un horaire, une traduction)",
      other: "Autre chose",
    },
    otherLabel: "Précisez",
    otherPlaceholder: "En quelques mots…",
    detailsLabel: "Donnez des détails",
    detailsPlaceholder: "Ce que vous avez fait, ce que vous attendiez, ce qui s'est passé…",
    contactToggle: "Vous pouvez me recontacter",
    contactHint: "Seulement pour vous répondre ou vous poser une question.",
    contactLabel: "Email ou téléphone",
    contactPlaceholder: "vous{'@'}exemple.fr ou 06 12 34 56 78",
    contextNote: "Envoyé avec : {context}.",
    context: {
      web: "Site web",
      app: "Application",
      ios: "iOS",
