              ...
              >
                ...
                <div class="flex items-center gap-3">
                  ...
                  <router-link
                    ...
                    class="w-8 h-8 flex items-center justify-center rounded-control text-text-secondary hover:text-primary hover:bg-black/5 dark:hover:bg-white/10 transition-colors flex-shrink-0"
